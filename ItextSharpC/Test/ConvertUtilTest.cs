...
namespace ItextSharpCv10.Test
{
    public class ConvertUtilTest
    {
        ...
        {
            var pixels = ConvertUtil.INToPdf(2);
        ...
        {
            var pixels = ConvertUtil.INToPdfWithPreviousHeight(2, 3);
        ...
        {
            var pixels = ConvertUtil.MMToPdf(60);
        ...
        {
            var pixels = ConvertUtil.MMToPdfFloat(60);
        ...
        {
            var pixels = ConvertUtil.PDFToMM(60);
        ...
        {
            var pixels = ConvertUtil.PdfToMMUnit25(6);
        ...
        {
            var pixels = ConvertUtil.PdfToMMUnit25(60);
